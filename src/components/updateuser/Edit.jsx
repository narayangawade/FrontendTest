...
const Edit = () => {
 ...
 useEffect(()=>{
    axios.get(`https://mernback-3-kgbg.onrender.com/api/getone/${id}`)
    .then((response)=>{
 ...
 const submitForm = async(e)=>{
    e.preventDefault();
    await axios.put(`https://mernback-3-kgbg.onrender.com/api/update/${id}`, user)
    .then((response)=>{
    ...
    <div className='addUser'>
        ...
        <form className='addUserForm' onSubmit={submitForm}>
            ...
            <div className="inputGroup">
                ...
                <input type="text" value={user.description} onChange={inputChangeHandler} id="description" name="description" autoComplete='off' placeholder='Last name' />
            </div>
            <div className="inputGroup">
